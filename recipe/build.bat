...
rem ---------------------------------------------------------------------------
rem HuBERT/WavLM TorchScript paths still overflow a 512 MB stack on Azure
rem Windows runners.  Reserve 1 GiB (1 073 741 824 bytes) instead.      #32
rem ---------------------------------------------------------------------------
...
set "CMAKE_ARGS=!CMAKE_ARGS:/STACK:134217728=/STACK:1073741824!"
